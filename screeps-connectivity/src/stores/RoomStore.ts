...
export class RoomStore extends TypedStore<RoomStoreEvents> {
  ...
  async terrain(room: string, shard: string | null, opts?: { silent?: boolean }): Promise<RoomTerrain> {
  ...
  async terrainBulk(rooms: string[], shard: string | null, opts?: { silent?: boolean }): Promise<Map<string, RoomTerrain>> {
